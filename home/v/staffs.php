        ...
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Staffs</li>
            ...
            <div class="card-header py-3">
                <h4 class="card-title" style="display: inline-block;">Staffs <?php if ($STAFFS_ADD_FLAG=='Y') { ?>
                <form method="post" action="index.php" enctype="multipart/form-data" style="display: inline-block;"><button class="btn btn-primary"><span style="color:white;">Add Staff</span>
                            </button>
            ...
            <div class="card-body">
              <div class="table-responsive">
               ...
               <tbody>
                    <?php 
                        $i = 0;
                        $DATA_BANK = $ERP->ERP_DATA('STAFFS_INFO', $GLOBAL_CID);
                ...
                <div class="modal-dialog">
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <b>Are you sure you want to Delete this Staff: <?php print $NAME; ?> ?</b>
